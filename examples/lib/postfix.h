/* $Id: postfix.h,v 1.9 2020/02/21 11:53:32 prs Exp $ */
/* (C)Pedro Reis dos Santos, 2004-2020 */
/* ld --dynamic-linker /lib/ld-linux.so.2 -lc -o program program.o */
#ifndef _postfix_h_
#define _postfix_h_

#define pfVERSION 1.10
...
#define pfWORD 8
#define pfCAST (long long)

#undef pfCONST
#define pfCONST pfLONG
...
#define pfSTORE2 "# STORE2\n\tpopq\t%%rcx\n\tpopq\t%%rax\n\tmovq\t%%rax, (%%rcx)\n"
#define pfCOPY2 "# COPY2\n\tpushq\t(%%rsp)\n"
#define pfDPUSH pfPUSH /* "# DPUSH\n\tsubq\t$8, %%rsp\n\tfstpl\t(%%rsp)\n" */
#define pfDPOP pfPOP /* "# DPOP\n\tfldl\t(%%rsp)\n\taddq\t$8, %%rsp\n" */
#else
#define pfI2D "# I2D\n\tcvtsi2sdq\t(%%rsp), %%xmm0\n\tmovq\t%%xmm0, (%%rsp)\n"
#define pfF2D "# F2D\n\tpopq\t%%rax\n\tmovq%%rax, %%xmm0\n\tcvtss2sd\t%%xmm0, %%xmm0\n\tmovq\t%%xmm0, %%rax\n\tpushq\t%%rax\n"
#define pfD2I "# D2I\n\tpopq\t%%rax\n\tmovq\t%%rax, %%xmm0\n\tcvttsd2siq\t%%xmm0, %%rax\n\tpushq\t%%rax\n"
